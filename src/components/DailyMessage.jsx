...
const MESSAGES = [
  ...
  { author: 'Amili', role: 'Lider de Media y Marketing, HC Media', messages: [
    'Las fotos de tus propiedades son tu primer argumento de venta. Si no estan bien iluminadas, pierdes el listing antes de empezar.',
    ...
    'El algoritmo de Meta favorece consistencia sobre volumen. Publicar 3 veces por semana supera publicar 10 veces un solo dia.',
    'El caption de un listing debe responder tres preguntas: por que esta propiedad, por que ahora, por que contigo.',
    'Las campanas de reactivacion con fotos de propiedades similares convierten mucho mejor que texto solo.',
  ]},
  { author: 'Adriana', role: 'Lider de Ventas y Alcance, Bonanza Quick Loans', messages: [
    ...
    'El bridge loan es una herramienta que pocos agentes explican a sus clientes. Hoy es un buen dia para aprenderla.',
    'El financiamiento no es el obstaculo, es el puente. Hay que construirlo junto al cliente desde el primer dia.',
    'Para clientes inversionistas, el DSCR loan abre puertas que el financiamiento convencional cierra.',
    'El rechazo de un prestamista no es el fin. Es el comienzo de una conversacion con Bonanza.',
    'Cuando un comprador duda por el precio, a veces la conversacion correcta es sobre la mensualidad, no el total.',
  ]},
  { author: 'Dollys', role: 'Soluciones al Cliente, HC Media', messages: [
    ...
    'La experiencia del cliente no es solo la transaccion. Es cada interaccion desde el primer lead hasta el cierre.',
    ...
    'Los clientes no recuerdan el precio que pagaron. Recuerdan como se sintieron durante el proceso.',
  ]},
  { author: 'Andrea', role: 'Lider de Seguros, Zivo Insurance', messages: [
    'El E&O no es opcional para un agente inmobiliario. Un error de omision puede costar mas que tu comision anual.',
    'Si usas tu auto para tours de propiedades, tu poliza personal probablemente no cubre un accidente en ese contexto.',
    'El seguro de propietario debe estar listo antes del cierre. No dejes que ese detalle detenga una transaccion.',
    'Una poliza de responsabilidad civil general protege tu negocio de reclamaciones que ni imaginas que pueden llegar.',
    'Zivo puede coordinar el seguro del comprador y del vendedor en la misma transaccion. Un punto de contacto.',
    'El seguro correcto no es el mas barato. Es el que te protege cuando mas lo necesitas.',
    'Cada cliente que cierra una propiedad necesita cobertura. Esa conversacion debes tenerla tu como agente.',
  ]},
]
...
export default function DailyMessage() {
  ...
  return (
    <div className="daily-msg">
      <div style={{ position: 'absolute', top: 0, right: 0, width: 200, height: 200, background: 'rgba(184,154,74,0.04)', borderRadius: '50%', transform: 'translate(60px,-60px)', pointerEvents: 'none' }} />
